...
async function savePatientEntry() {
    const patientData = {
        ...
        testResults: getTestResults(), // Now included directly with the form submission
        billing: {
            subtotal: parseFloat(document.getElementById('subtotalAmount').textContent.replace('₹', '')) || 0,
            discountPercentage: parseFloat(document.getElementById('discountInput').value) || 0,
            cgstRate: parseFloat(document.getElementById('cgstInput').value) || 0,
            cgstAmount: parseFloat(document.getElementById('cgstAmount').textContent.replace('₹', '')) || 0,
            sgstRate: parseFloat(document.getElementById('sgstInput').value) || 0,
            sgstAmount: parseFloat(document.getElementById('sgstAmount').textContent.replace('₹', '')) || 0,
            igstRate: parseFloat(document.getElementById('igstInput').value) || 0,
            igstAmount: parseFloat(document.getElementById('igstAmount').textContent.replace('₹', '')) || 0,
